...
var _githubInjection = __webpack_require__(1);
...
(0, _githubInjection2.default)(window, function () {
    console.log(location.href);
    if (!testUrl(location.href)) return;
...
function testUrl(url) {
    var urlObj = (0, _urlParse2.default)(url);
